...
export default function App() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("openclaw-theme") as Theme | null;
  ...
  return (
    <div className={`min-h-screen ${themeClasses}`}>
      <div className="mx-auto flex min-h-screen max-w-[640px] flex-col px-6 py-8">
        ...
        <div className="mt-6">
          <div className={`h-2 w-full rounded-full ${theme === "dark" ? "bg-white/10" : "bg-slate-200"}`}>
            <div
          ...
          {step === 5 && (
            <section className="space-y-6">
              <div>
                ...
                <p className={`mt-2 ${textMuted}`}>
                  Review your setup and download your config files.
                </p>
              </div>
